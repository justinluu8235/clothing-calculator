...
const AppWithRouter = () => {
  ...
  const handleLogout = () => {
    ...
    axios.get(`${ENDPOINT}/logout/`).then((res) => {
      ...
      <QueryClientProvider client={queryClient}>
        <Router>
          ...
          <Routes>
            ...
            />
            <Route
              path="/app/selected_for_you"
              element={<ShowRoom currentUser={currentUser} />}
            />
            <Route
              path="/app/tradeshow"
              element={
                <ShowRoom currentUser={currentUser} isTradeShow={true} />
              }
            />
            <Route
              path="/app/showroom"
              element={<ShowRoom currentUser={currentUser} isShowRoom={true} />}
            />
            <Route
              path="/app/staff"
              element={<StaffStyles currentUser={currentUser} />}
            />
          </Routes>
        </Router>
      </QueryClientProvider>
